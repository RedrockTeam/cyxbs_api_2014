...
<body>
<form action="<?php echo ($ADD_URL); ?>" method="post" class="definewidth m20" enctype="multipart/form-data">
<input type="hidden" name="id" value="" />
<table class="table table-bordered table-hover ">
    <tr>
        <td width="10%" class="tableleft">菜编号</td>
        <td><input type="text" name="dish_id" value="<?php echo ($shop["dish_id"]); ?>" style="display:none;"/><span style="font-weight:bold;font-size:20px;color:blue;margin-left:5px;"><?php echo ($shop["dish_id"]); ?></span></td>
    </tr>
	 <tr>
        <td class="tableleft">菜名</td>
        <td ><span style="font-weight:bold;font-size:20px;color:blue;margin-left:5px;"><?php echo ($shop["dish_name"]); ?></span></td>
    </tr>  
	 <tr>

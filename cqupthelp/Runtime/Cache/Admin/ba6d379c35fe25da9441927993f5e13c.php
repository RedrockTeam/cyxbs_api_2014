...
<form class="form-inline definewidth m20" action="index.html" method="get">  
    ...
    <a href="<?php echo ($node_add); ?>"><button type="button" class="btn btn-success" >新增</button></a>
</form>
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($vo["comment_id"]); ?></td>
			  <td><?php echo ($vo["comment_author_name"]); ?></td>
			  <td><?php echo ($vo["comment_date"]); ?></td>
			  <td><?php echo (substr($vo["comment_content"],0,35)); ?>...</td>
            <td>
                  <a href="<?php echo U("Comment/content_edit?edit_id=".$vo['comment_id']); ?>">编辑</a> 
				  <a  onclick="return del()"  href="<?php echo U("Comment/del?del_id=".$vo['comment_id']); ?>">删除</a> 
            </td>

...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			 <td><?php echo $i;?></td>
			  <td><?php echo ($vo["shopimg_id"]); ?></td>
			  <td><img src="<?php echo ($UPLOAD_ROOT_URL); echo ($vo["shopimg_src"]); ?>" width="100px"/></td>
			  <td><?php echo ($vo["shopimg_src"]); ?></td>
            <td>
				  <a   onclick="return del()"  href="<?php echo U("Upload/del?del_id=".$vo['shopimg_id']."&shop_id=".$shop_thing['shop_id']); ?>">删除</a> 
            </td>

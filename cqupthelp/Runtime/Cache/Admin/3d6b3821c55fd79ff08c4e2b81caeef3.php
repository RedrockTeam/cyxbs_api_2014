...
<table class="table table-bordered table-hover ">
    <tr>
        ...
        <td><input type="text" name="shop_id" value="<?php echo ($edit_list['shop_id']); ?>" style="display:none;"/><span style="font-weight:bold;font-size:20px;color:blue;margin-left:90px;"><?php echo ($edit_list['shop_id']); ?></span></td>
    </tr>
    <tr>
	...
	<tr>
        ...
        <td >
        	<textarea id="editor_id" name="shop_content" style="width:700px;height:300px;">
				<?php echo ($edit_list['shop_content']); ?>
			</textarea>
		</td>
    </tr>  
	<tr>
        ...
        <td >
        	<textarea id="editor_id2" name="shop_sale_content" style="width:700px;height:300px;"><?php echo ($edit_list['shop_sale_content']); ?></textarea>
		</td>
    </tr>  

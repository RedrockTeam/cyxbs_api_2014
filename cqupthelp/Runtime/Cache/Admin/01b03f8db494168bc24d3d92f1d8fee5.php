...
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($vo["shop_address"]); ?></td>
			  <td><?php echo ($vo["shop_tel"]); ?></td>
			  <td><?php echo (substr($vo["shop_content"],0,35)); ?>...</td>
			  <td><?php echo (substr($vo["shop_sale_content"],0,35)); ?>...</td>
            <td>
                  <a href="<?php echo U("Node/content_edit?edit_id=".$vo['shop_id']); ?>">编辑</a> 
				  <a  onclick="return del()"  href="<?php echo U("Node/del?del_id=".$vo['shop_id']); ?>">删除</a> 
            </td>
